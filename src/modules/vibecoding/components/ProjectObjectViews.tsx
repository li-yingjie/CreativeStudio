...
const CONTENT: Record<string, Record<string, ObjectContent>> = {
  ...
  '射击小游戏': {
    ...
    页面: {
      ...
      note: '游戏内的界面（场景）。',
      items: [
        { icon: '▶️', title: '开始界面', desc: '标题、开始按钮、最高分展示。' },
        { icon: '🚀', title: '游戏进行中', desc: '飞机、弹幕、敌机波次与 HUD。' },
        { icon: '⏸️', title: '暂停面板', desc: '继续 / 重开 / 音效开关。' },
        { icon: '🏁', title: '结算界面', desc: '本局得分、波次、获得增益。' },
        { icon: '🏆', title: '排行榜', desc: '好友榜与全服榜。' },
        { icon: '🛒', title: '商店', desc: '解锁机型与皮肤。' },
      ],
    },
    玩法: {
      type: 'cards',
