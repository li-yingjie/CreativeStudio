...
export const XIAHUA_BUILD_SCRIPT: BuildStep[] = [
  ...
  },
  {
    ...
    view: {
      ...
      cards: [
        { type: 'play', badge: '玩法', title: '核心玩法 · 框架占位可试玩', desc: '9 张卡 / 4 档奖励 / 4 个抽卡来源' },
      ],
    },
    stage: 'playable',
    gate: {
 ...
 *
 * 模板抽象掉的是「集卡兑奖」这套结构：5 个页面、抽卡 → 集卡 → 解锁档位 →
 * 领奖的链路、全部素材槽位。复刻一个新活动要动的只有两样：素材（换皮）和
...
export const XIAHUA_TEMPLATE_DOCUMENT: XiahuaTemplateDocument = {
  ...
  fixed: [
    ...
    '26 个素材槽位的命名与图层关系，主视觉支持背景 / 贴片 / 主角分层',
  ],
  replaceable: [
    ...
    { slot: '奖励与任务', current: '4 档奖励 / 4 个抽卡任务', usage: '确认奖励门槛、奖品发放方式、抽卡机会来源与活动周期' },
    { slot: '扩展玩法', current: '可选，原方案待定', usage: '模板没有的副玩法单独确认，不改变主链路与次数账本' },
  ],
  steps: [
...
export const XIAHUA_CLONE_PROJECT_DOCUMENT: XiahuaTemplateDocument = {
  ...
  version: '项目文档 · 待确认',
  summary:
    '本项目沿用「夯爆了」已经验证过的集卡 H5 页面结构和主链路，主题改为夏日玩水，卡池改为 7 种冲浪装备，并加入金豆冲浪副玩法。素材、奖励和任务按本期需求重新生成，模板的页面关系与交互规则继续保留。',
  fixed: [
    '5 个页面：活动主会场、开卡结算、我的卡册、兑奖弹窗、活动规则',
    '1 条主链路：抽卡 → 集卡 → 解锁奖励档位 → 领奖',
    '卡槽点亮、重复卡赠送、抽卡次数、奖励弹窗与状态反馈',
    '模板已验证的页面版式、图层关系和交互热区',
  ],
  replaceable: [
    { slot: '活动主题与文案', current: '夏日玩水 / 夏日冲浪', usage: '生成海边主题、活动标题、按钮和页脚文案' },
    { slot: '主视觉与角色', current: '夏日海边 / 泳圈小马', usage: '生成海滩底景、玩水道具贴片和夏日角色造型' },
    { slot: '卡池与卡面', current: '7 种冲浪装备', usage: '生成 7 种装备卡面，卡槽数量与集齐门槛同步调整' },
    { slot: '奖励与任务', current: '4 档奖励 / 5 个抽卡任务', usage: '配置券、足金抽签码、到店点亮等本期规则' },
    { slot: '扩展玩法', current: '金豆冲浪', usage: '在主玩法下增加副玩法，共用活动次数与奖励状态' },
  ],
  steps: [
    '确认本项目文档中的主题、卡池、奖励、任务和副玩法。',
    '按模板页面结构生成夏日冲浪的素材与玩法配置清单。',
    '分组生成素材并逐项确认，保留模板的页面和交互关系。',
    '完成替换后生成活动预览，进入编辑调整。',
  ],
  confirm: [
    '用户需求：夏天玩水主题，集 7 种冲浪装备，奖励以券为主，最高档使用足金抽签码，增加金豆冲浪副玩法，主角保留小马。',
    '模板继承：页面结构、抽卡到领奖的主链路和基础交互；本期重新生成主题素材并配置活动参数。',
  ],
}
...
export const CLONE_ASSET_DIFF: CloneDiffItem[] = [
  ...
  { id: 'a-title', batch: 1, from: '活动标题字 · 暖橙夜市', to: '活动标题字 · 夏日冷调', note: '字形和活动名沿用，只换配色适配海边底图' },
  ...
  { id: 'a-tier', batch: 3, from: '奖励档位图 · 券面 4 档', to: '奖励档位图 · 券面 3 档 + 足金抽签码', note: '面额和门槛都变了' },
...
export const CLONE_GAMEPLAY_DIFF: CloneDiffItem[] = [
  ...
  { id: 'g-tiers', batch: 3, from: '奖励门槛 2 / 4 / 7 / 9 种', to: '奖励门槛 1 / 4 / 6 / 7 种', note: '¥3 清凉开运券 / ¥12 玩水装备券 / ¥23 一顺到底券 / 足金顺顺马' },
  { id: 'g-goods', batch: 3, from: '实物奖：小马黄金转运珠', to: '实物奖：足金顺顺马抽签码', note: '走抽签码发放，不直接发货' },
  { id: 'g-tasks', batch: 3, from: '抽卡任务 4 个', to: '抽卡任务 5 个', note: '多一条「到店点亮避暑玩水商户」' },
  { id: 'g-sub', batch: 3, from: '副玩法：无', to: '副玩法：金豆冲浪', note: '模板没有，属于新增，要单独搭' },
...
export const TEMPLATE_CLONE_SCRIPT: BuildStep[] = [
  ...
  },
  {
    ...
    view: {
      kind: 'ai',
      text: '我根据你的需求和「夯爆了 · 集卡 H5 模板」整理了一份「夏日冲浪 · 顺风顺水」项目文档：页面结构和集卡主链路沿用模板，本期的主题素材、卡池、奖励、任务和副玩法单独配置。先确认这份项目文档，后续就按它生成活动。',
      cards: [
        {
          type: 'doc',
          badge: '项目文档',
  ...
  },
  {
    ...
    view: {
      kind: 'ai',
      text: '项目文档确认了。本期配置已经从你的描述中整理出来：夏日玩水主题、7 种冲浪装备、券和足金抽签码、5 个抽卡任务，再加金豆冲浪副玩法。页面结构和抽卡到领奖的主链路沿用模板，接下来生成对应的素材与玩法清单。',
    },
    phase: 'doc',
    hold: 2200,
  },
  {
    ...
    view: {
      ...
      title: '整理项目配置',
      lines: [
        '模板提供 5 个页面、集卡主链路、卡槽状态和奖励交互，页面关系与用户路径已经验证过。',
        '本期活动配置来自你的需求：7 种冲浪装备、4 档奖励、5 个抽卡任务和金豆冲浪副玩法。',
        '需要重新生成的是夏日主题素材、装备卡面、奖励视觉与活动文案，模板的页面和交互关系保持不变。',
  ...
  },
  {
    ...
    view: { kind: 'user', text: '装备卡先做 7 种就行，别扩到 9 种；金豆冲浪这期一起做' },
    hold: 1200,
  },
  {
    ...
    view: {
      kind: 'ai',
      text: '卡池按 7 种走，门槛调整为 1 / 4 / 6 / 7 种；金豆冲浪作为本期副玩法加入主玩法下方，共用活动次数与奖励状态。项目配置已更新，可以继续生成。',
    },
    phase: 'diff',
  ...
  /* ── 第 2 批：卡池与卡面 ── */
  {
    ...
    view: {
      ...
      lines: [
        ...
        '每种照样出两态：已点亮的彩色卡面和待点亮的灰态，卡册和结算页共用同一批图。',
        '卡面是这轮最费时间的一批，14 张图，所以单独占一批。',
      ],
    },
    replaceBatch: 2,
    hold: 2400,
  ...
  /* ── 第 3 批：档位 / 任务 / 副玩法 ── */
  {
    ...
    view: {
      ...
      lines: [
        ...
        '任务加一条到店点亮；金豆冲浪是模板里没有的，单独搭一块副玩法接在主玩法下面，共用同一套次数账本。',
      ],
    },
    replaceBatch: 3,
    hold: 2400,
  },
  {
    ...
    view: {
      kind: 'ai',
      text: '「夏日冲浪 · 顺风顺水」已生成：7 种装备卡、4 档奖励、足金抽签码，金豆冲浪已接入主玩法。页面结构和抽卡到领奖的链路沿用模板，本期只替换了项目文档中确认的素材和玩法参数。需要调整的地方直接告诉我。',
      cards: [
