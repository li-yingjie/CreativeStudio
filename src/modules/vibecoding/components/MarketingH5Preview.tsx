...
export default function MarketingH5Preview() {
  return (
    <div className="relative flex h-full w-full flex-col overflow-hidden bg-[#251517] text-[#35151d]">
      ...
      <main className="thin-scroll min-h-0 flex-1 overflow-y-auto px-3 pb-5 pt-3">
        <HeroBanner />
        <CountdownCard />
        <IntroCard />
        <LotteryCard />
...
function CountdownCard() {
  return (
    <section className="mt-8 rounded-[24px] bg-white px-4 py-4 text-center shadow-sm">
...
function IntroCard() {
  return (
    <DecoratedCard className="mt-8 px-5 pb-6 pt-5">
...
function LotteryCard() {
  return (
    <DecoratedCard className="mt-8 px-5 pb-8 pt-5">
...
function TaskCard() {
  return (
    <DecoratedCard className="mt-8 px-5 pb-7 pt-5">
